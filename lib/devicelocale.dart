/// Copyright (c) 2019-2023, nicolastinkl. All rights reserved. Use of this source code
...
class Devicelocale {
  ...
  static Future<String?>  currentVersion(String version) async {
    final String? locale = await _channel.invokeMethod('currentVersion', {'version': version});    
    return locale;
  }
